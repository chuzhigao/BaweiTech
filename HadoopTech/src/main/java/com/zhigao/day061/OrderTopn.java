...
public class OrderTopn {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job, new Path("C:\\HadoopTeacher\\data\\day061\\input"));
		FileOutputFormat.setOutputPath(job, new Path("C:\\HadoopTeacher\\data\\day061\\output"));
